...
def save_all(
    ...
    # -------- clusters summary (deskriptif, bukan labeling) --------
    clusters = (
    ...
    # -------- members (tanpa tfidf_json, tanpa is_recurring) --------
    members = df.copy()
...
def main():
    ...
    ap.add_argument("--thresholds", default="0.65,0.70,0.75,0.80")
